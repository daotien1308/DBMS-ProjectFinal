...
VALUES (N'NV01',N'Hoàng Ngọc Trâm',N'Nhân viên','0344646445','2017-05-06',7000000,'1995-05-06');

INSERT INTO NHANVIEN(MaNV,TenNV,ChucVu,SDT_NV,NgayLam,Luong,NgaySinh) 
VALUES (N'NV02',N'Nguyễn Đình Tùng',N'Nhân viên','0352648569','2018-06-09',6000000,'1993-02-01');

INSERT INTO NHANVIEN(MaNV,TenNV,ChucVu,SDT_NV,NgayLam,Luong,NgaySinh) 
VALUES (N'NV03',N'Võ Hoàng Tam',N'Nhân viên','0356987584','2016-02-06',7500000,'1990-03-01');

INSERT INTO NHANVIEN(MaNV,TenNV,ChucVu,SDT_NV,NgayLam,Luong,NgaySinh) 
VALUES (N'NV04',N'Nguyễn Thị Kiều Linh',N'Nhân viên','0302365847','2020-02-06',6000000,'1997-06-08');

INSERT INTO NHANVIEN(MaNV,TenNV,ChucVu,SDT_NV,NgayLam,Luong,NgaySinh) 
VALUES (N'NV05',N'Nguyễn Văn Đức',N'Quản Lý','0302121145','2015-02-03',7500000,'1990-06-01');

-- 5. San pham

INSERT INTO SANPHAM(MaSP,TenSP,Gia,NSX,HSD,MaDM,HinhSP) 
VALUES (N'SP01',N'Kem Dưỡng La Roche-Posay Làm Dịu',222000,'2020-03-06','2025-03-06','DM02','https://media.hasaki.vn/catalog/product/1/0/100170024-1310_1_img_380x380_64adc6_fit_center.jpg');

INSERT INTO SANPHAM(MaSP,TenSP,Gia,NSX,HSD,MaDM,HinhSP) 
VALUES (N'SP02',N'Nước Hoa Nam HUGO BOSS Just Different EDT 40ml',1520000,'2020-05-06','2025-05-06','DM01','https://media.hasaki.vn/catalog/product/c/h/chung-nhan-dai-ly-phan-phoi-nuoc-hoa-chinh-hang-luxasia_9_img_300x300_b798dd_fit_center.jpg');

INSERT INTO SANPHAM(MaSP,TenSP,Gia,NSX,HSD,MaDM,HinhSP) 
VALUES (N'SP03',N'Mặt Nạ Ngủ Môi Laneige Hương Táo 20g',330000,'2021-03-06','2026-03-06','DM03','https://media.hasaki.vn/catalog/product/g/o/google-shopping-mat-na-ngu-moi-laneige-huong-tao-20g_img_300x300_b798dd_fit_center.jpg');

INSERT INTO SANPHAM(MaSP,TenSP,Gia,NSX,HSD,MaDM,HinhSP) 
VALUES (N'SP04',N'Dầu Tẩy Trang Naris Cosmetic Dành Cho Da Mụn 100ml',222000,'2020-03-03','2022-03-03','DM04','https://media.hasaki.vn/catalog/product/d/a/dau-tay-trang-danh-cho-da-mun-naris-100ml_img_300x300_b798dd_fit_center.jpg');

INSERT INTO SANPHAM(MaSP,TenSP,Gia,NSX,HSD,MaDM,HinhSP) 
VALUES (N'SP05',N'Kem Nhuộm Tóc Beautylabo Vanity Color Màu Đen Khói',500000,'2021-03-06','2027-03-06','DM05','https://media.hasaki.vn/catalog/product/g/o/google-shopping-kem-nhuom-toc-beautylabo-vanity-color-mau-den-khoi_img_300x300_b798dd_fit_center.jpg');
